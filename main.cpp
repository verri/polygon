...
auto is_inside(coord<typename polygon_traits<Polygon>::value_type>, const Polygon&,
               simple_polygon_tag)
{
...
template <typename Polygon,
          typename Tag = typename polygon_traits<Polygon>::polygon_category_tag>
auto is_inside(coord<typename polygon_traits<Polygon>::value_type> point,
               const Polygon& pol)
{
